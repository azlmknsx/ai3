...
CONTENT_BY_LABEL: dict[str, dict[str, list[str]]] = {
     ...
     labels[0]: {
       "texts": ["치킨은 튀김 가루를 묻힌 닭을 튀긴 음식이다."],
       "images": ["https://lh6.googleusercontent.com/proxy/Q6PvKZCdwIyynIVF8Wi46CfOk9L5Js_OJqq3BS0UAy2MKgaVsn6Cj0v8GdrA5yfMT1MYsQNZXvSYmKpddzZsmP6Oj_IjegzM"],
